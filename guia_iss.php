...
use BaconQrCode\Renderer\RendererStyle\RendererStyle;
    ...
    if (is_numeric($get) == false) {
        ...
        //gera o endereço para verificação do boleto
        $api_end = 'localhost/API-boletos---PHP';
        $check_out = $api_end . gera_autenticador($nossonumero);
       ...
       echo $writer->writeFile($check_out, 'checkout/qrcode/'.$id.'.svg');
        // INCLUDE DO LAYOUT
